...
const QUOTE_DATA = {
  ...
  carrierComparison: [
    { carrier: 'ZIM',     rateUsd: 1150, transitDays: 32, frequency: 'Semanal', freeTimeDays: 20, status: 'Recomendado',          notes: 'Mejor precio + free time alto' },
    { carrier: 'COSCO',   rateUsd: 1180, transitDays: 35, frequency: 'Semanal', freeTimeDays: 14, status: 'Alternativa',           notes: 'Free time bajo' },
    { carrier: 'MSC',     rateUsd: 1450, transitDays: 38, frequency: 'Quincenal', freeTimeDays: 21, status: 'Más caro pero acepta IMO', notes: 'Ipanema service' },
    { carrier: 'Maersk',  rateUsd: 1290, transitDays: 34, frequency: 'Semanal', freeTimeDays: 14, status: 'Alternativa',           notes: 'Sin contrato vigente' },
  ],
  markupPercent: 12.6,
  markupAmount: 145,
